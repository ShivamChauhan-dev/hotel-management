...
import { createRoom, editRoom, deleteRoom, getRooms, getRoom, bulkCreateRooms, bulkDeleteRooms, getAllRooms, updateRoomStatus } from '../controllers/roomController.js';
import { authMiddleware } from '../middleware/authMiddleware.js';
import { roleMiddleware } from '../middleware/roleMiddleware.js';

const router = express.Router();

router.get('/admin', authMiddleware, roleMiddleware(['admin']), getAllRooms);
...
router.put('/:id/status', authMiddleware, roleMiddleware(['admin']), updateRoomStatus);
